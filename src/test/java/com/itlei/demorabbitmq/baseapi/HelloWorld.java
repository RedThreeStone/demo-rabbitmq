...
/**
 * @author uu
 * @date 2020/7/25 12:17
 * @desciption 对应官网的helloword模式 一个生产者 一个消费者
 * 交换机有direct fanout heads topic四种模式 direct fanout可以不需要路由键 默认的路由键为队列名册 topic需要设置路由键  heads根据消息里的属性来做队列和交换机的匹配  topic匹配路由键
 */
public class HelloWorld {
    ...
    private final String QUEUENAME="bdcjqc";
    private final String EXECHANGENAME="bdcjexchange";
