 ...
 * @desciption 主题模式 设置交换机类型为exchange  queue通过路由键加#,*绑定多种路由键去消费数据
 */
public class Topic {
    ...
    private final String QUEUENAME1="topicqueue1";
    private final String QUEUENAME2="topicqueue2";
    private final String EXECHANGENAME="topicExchange";
    private final String ROUTINGKEY1="qc.bus";
    private final String ROUTINGKEY2="qs.bus";
    private final String ROUTINGKEY3="qs.log";
...
//            propties.put("alternate-exchange","备用交换机名");
            channel.exchangeDeclare(EXECHANGENAME, BuiltinExchangeType.TOPIC,true,false,false,null);
            //如果不指定交换机 有个默认的交换机会被使用 routingkey 名为queue的名字,且不需要显示绑定
            channel.queueDeclare(QUEUENAME1,true,false,false,null);
            channel.queueDeclare(QUEUENAME2,true,false,false,null);
            channel.queueBind(QUEUENAME1,EXECHANGENAME,"qc.*");
            channel.queueBind(QUEUENAME2,EXECHANGENAME,"qs.*");
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void producer() throws IOException, TimeoutException {
        ...
        for (int i = 1;i<100;i++){
            ...
            channel.basicPublish(EXECHANGENAME,ROUTINGKEY3,false,false,null,(i+"hello").getBytes("UTF-8"));
        }
    }
    @Test
